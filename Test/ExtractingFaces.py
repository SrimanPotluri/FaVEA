...
def detect_faces(emotion):
    files = glob.glob("/Users/sriman/Documents/sorted_set/%s/*" % emotion)  # Get list of all images with emotion
    ...
    for f in files:
        ...
        for (x, y, w, h) in facefeatures:  # get coordinates and size of rectangle containing face
            ...
            try:
                ...
                cv2.imwrite("/Users/sriman/Documents/dataset/%s/%s.jpg" % (emotion, filenumber), out)  # Write image
            except:
